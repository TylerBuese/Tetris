...
int main()
{
    ...
    while (!WindowShouldClose())
    {
        ...
        if (IsKeyPressed(KEY_ONE))
        {
            ...
            case 0:
            {
                shape.drawShape(Ione, Itwo, Ithree, Ifour);
                break;
            }
            case 1:
            {
                shape.drawShape(Lone, Ltwo, Lthree, Lfour);
                break;
            }
            case 2:
            {
                shape.drawShape(Sone, Stwo, Sthree, Sfour);
                break;
            }
            case 3:
            {
                shape.drawShape(Tone, Ttwo, Tthree, Tfour);
                break;
            }
            case 4:
            {
                shape.drawShape(SQone, SQtwo, SQthree, SQfour);
                break;
            }
